...
import 'package:provider/provider.dart';
import '../../../../view_models/auth_view_model.dart';
import 'package:graduation___part1/views/ad_list/view/ad_list_view.dart' as adView;
import 'package:graduation___part1/views/create_ad_view.dart';
import 'package:graduation___part1/views/Statistics.dart';
import 'package:graduation___part1/views/profile/view_model/autoProfile.dart';
...
*/
import 'package:flutter/material.dart';
import 'package:graduation___part1/views/statistics/view/Statistics.dart';
import 'package:graduation___part1/views/create_ad/view/create_ad_view.dart';
import 'package:graduation___part1/views/home/Bar_home/animations/Bar_home_animations.dart';
...
import '../../../ad_list/view/ad_list_view.dart' as adView;

class HomeView1 extends StatefulWidget {
  const HomeView1({Key? key}) : super(key: key);

  @override
  HomeView1State createState() => HomeView1State();
}

class HomeView1State extends State<HomeView1> with TickerProviderStateMixin {
  late final HomeAnimations _animations;

  @override
  void initState() {
    super.initState();
    _animations = HomeAnimations(vsync: this);
        ...
        builder: (context, viewModel, _) {
          return Scaffold(
            appBar: HomeAppBar(
              ...
              onClose: () {
                _animations.fadeController.reverse().then((_) {
                  Navigator.push(
                    context,
                    PageRouteBuilder(
                      pageBuilder: (context, animation, secondaryAnimation) =>
            ...
            body: Container(
              ...
              child: FadeTransition(
                ...
                child: ListView(
                  ...
                  children: [
                    HomeCard(
                      scaleAnimation: _animations.scaleAnimations[0],
                      title: 'Get Ads',
                      subtitle: 'Choose an item for your ad',
                      icon: Icons.list,
                      onTap: () => _navigateWithAnimation(
                        context,
                        const adView.AdListView(),
                      ),
                    ),
                    HomeCard(
                      scaleAnimation: _animations.scaleAnimations[1],
                      title: 'Create Ad',
                      subtitle: 'Create your own ad',
                    ...
                    HomeCard(
                      scaleAnimation: _animations.scaleAnimations[2],
                      title: 'My Profile',
                      subtitle: '',
                      icon: Icons.person,
                      onTap: () => _navigateWithAnimation(
                    ...
                    HomeCard(
                      scaleAnimation: _animations.scaleAnimations[3],
                      title: 'Statistics',
                      subtitle: 'View your ad performance',
                    ...
                    HomeCard(
                      scaleAnimation: _animations.scaleAnimations[4],
                      title: 'Log Out',
                      subtitle: '',
                      icon: Icons.logout,
                      onTap: () {
                        showGeneralDialog(
                          ...
                          pageBuilder:
                            ...
                            return ScaleTransition(
                              ...
                              child: HomeLogoutDialog(viewModel: viewModel),
                            );
                          },
                        );
                      },
