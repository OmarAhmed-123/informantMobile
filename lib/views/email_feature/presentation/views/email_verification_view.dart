...
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:graduation___part1/views/email_feature/presentation/views_models/email_cubit/email_cubit.dart';
      ...
      body: Container(
        ...
        child: Padding(
          ...
          child: BlocProvider(
            ...
            child: BlocConsumer<EmailCubit, EmailCubitStates>(
              listener: (context, state) {
...
class EmailVerificationView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Builder(
        builder: (context) {
          final viewModel = Provider.of<EmailVerificationViewModel>(context);
