...
class profitViewS extends State<ProfitView>
  ...
  Widget buildCard(List<Map<String, dynamic>> ads) {
  ...
  Widget buildChart(List<Map<String, dynamic>> ads) {
    return Container(
      height: 300,
      padding: const EdgeInsets.all(16),
      child: LineChart(
  ...
  Widget buildAdList(List<Map<String, dynamic>> ads) {
    return ListView.builder(
      shrinkWrap: true,
      physics: const NeverScrollableScrollPhysics(),
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        body: BlocBuilder<AdsCubit, List<Map<String, dynamic>>>(
          builder: (context, ads) {
