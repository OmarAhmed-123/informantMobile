                                ...
                                child: BlocConsumer<RegisterCubit,
                                  ...
                                  listener: (context, state) {
                                    if (state is RegisterSuccessState) {
                                      ...
                                      print(
                                          "Registration failed: ${state.errorMsg}");
                                    }
                                  },
                                  builder: (context, state) {
                                    if (state is RegisterLoadingState) {
                                      ...
                                      return SizedBox(
                                        ...
                                        child: ElevatedButton(
                                          onPressed: () async {
                                            // Trigger the registration process using the cubit
...
*/
import 'package:flutter/material.dart';
import 'package:graduation___part1/views/register_feater/presentation/views_models/register_view_model.dart';
import 'package:provider/provider.dart';
