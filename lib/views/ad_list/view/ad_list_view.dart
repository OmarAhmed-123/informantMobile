...
import '../../ad_detail/view/ad_detail_view.dart';
...
import '../view_model/ad_list_view_model.dart';
...
class _AdListViewState extends State<AdListView> with TickerProviderStateMixin {
  ...
  late Animation<Offset> _slideAnimation;
  late Animation<double> _scaleAnimation;
  late AdListViewModel _viewModel;

  @override
  void initState() {
    super.initState();
    _initializeAnimations();
    _viewModel = AdListViewModel();
  }
  ...
  void _navigateToDetails(Map<String, dynamic> ad, int index) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => AdDetailView(
          ad: _viewModel.createAdFromMap(ad, index),
        ),
      ),
    );
  }
    ...
    return ChangeNotifierProvider.value(
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          child: Consumer<AdListViewModel>(
            builder: (context, viewModel, _) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) => AdCard(
                  ad: viewModel.ads[index],
                  index: index,
                  fadeAnimation: _fadeAnimation,
                  scaleAnimation: _scaleAnimation,
                  slideAnimation: _slideAnimation,
                  onImageChanged: viewModel.setCurrentImageIndex,
